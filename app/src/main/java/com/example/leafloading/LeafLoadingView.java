...
import static com.example.leafloading.UiUtils.dipToPx;
...
public class LeafLoadingView extends View {
    ...
    private int mLeafHeight, mLeafWidth;
    ...
    public LeafLoadingView(Context context, @Nullable AttributeSet attrs) {
        ...
        LeafFactory mLeafFactory = new LeafFactory();
    ...
    private void drawLeafs(Canvas canvas) {
        ...
        for (int i = 0; i < mLeafInfos.size(); i++) {
            ...
            if (currentTime > leaf.startTime && leaf.startTime != 0) {
                ...
                float rotateFraction = ((currentTime - leaf.startTime) % mLeafRotateTime) / mLeafRotateTime;
