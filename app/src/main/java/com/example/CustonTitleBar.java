...
public class CustonTitleBar extends RelativeLayout {
    private Button titleBarLeftBtn;
    private TextView titleBarTitle;
    private Button titleBarRightBtn;

    public CustonTitleBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        ...
        if (attributes != null) {
            ...
            if (!TextUtils.isEmpty(leftButtonText)) {
                ...
                int leftButtonDrawable = attributes.getResourceId(R.styleable.CustomTitleBar_left_button_drawable, R.mipmap.img1);
